...
public class AsyncHttpClient {
    ...
    private final ConcurrentHashMap<Context, AsyncHttpRequestTask> tasks;
     ...
     */
    public AsyncHttpClient(boolean usingThreadPool) {
        this.usingThreadPool = usingThreadPool;
        ...
        tasks = new ConcurrentHashMap<Context, AsyncHttpRequestTask>();
   ...
   /**
    ...
    private void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, AsyncHttpResponseHandler responseHandler, Context context) {
        ...
        if (usingThreadPool) {
            ...
            AsyncHttpRequestTask asyncTask = new AsyncHttpRequestTask(client, httpContext, uriRequest, responseHandler);
            asyncTask.execute();
            tasks.put(context, asyncTask);
        }
    }
