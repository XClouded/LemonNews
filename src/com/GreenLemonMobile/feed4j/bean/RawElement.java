package com.GreenLemonMobile.feed4j.bean;
	...
	public String getAttributeValue(String namespaceURI, String name) {
		if (attributes == null) {
			...
			for (Iterator i = attributes.iterator(); i.hasNext();) {
				...
				if (aux.getName().equals(name) && ((namespaceURI == null || aux.getNamespaceURI() == null) || aux.getNamespaceURI().equals(namespaceURI))) {
				    return aux.getValue();
				}
			}
			return null;
		...
		if (nodes == null) {
			...
			for (Iterator i = nodes.iterator(); i.hasNext();) {
				...
				if (node instanceof RawElement) {
					...
					if (aux.getName().equals(name) && ((aux.getNamespaceURI() == null || namespaceURI == null) || aux.getNamespaceURI().equals(namespaceURI))) {
                        list.add(aux);
                    }
				}
			}
