...
public final class DisplayUtil {
    ...
    public static final class CompatibilityInfo {
        ...
        public CompatibilityInfo(android.content.pm.ApplicationInfo appInfo) {
            ...
            if ((appInfo.flags & DisplayUtil.ApplicationInfo.FLAG_SUPPORTS_XLARGE_SCREENS) != 0) {
                compatibilityFlags |= XLARGE_SCREENS | CONFIGURED_XLARGE_SCREENS;
            }
    ...
    public static final class DisplayMetrics {
        ...
        private static int getDeviceDensity() {
            ...
            try {
                final Class<?> theClass = Class.forName("android.os.SystemProperties");
                ...
                if (getInt != null) {
                    ...
                    //final Class<?>[] paramsTypes = getInt.getParameterTypes();
                    //for (Class<?> paramClass : paramsTypes) {
                    //    Log.d("getIMSI","method getInt : " + paramClass.getName());
                    //}
                    final String keyLcdDensity = new String("ro.sf.lcd_density");
                    final Integer lcdDensity = (Integer) getInt.invoke(null, new Object[]{keyLcdDensity, DENSITY_DEFAULT});
                    final String keyQemuLcdDensity = new String("qemu.sf.lcd_density");
                    final Integer qemuLcdDensity = (Integer) getInt.invoke(null, new Object[]{keyQemuLcdDensity, lcdDensity});
    ...
    public static float getApplicationScale(Context context) throws NameNotFoundException {
        return new DisplayUtil.CompatibilityInfo(context.getPackageManager().getApplicationInfo(
                context.getPackageName(), PackageManager.GET_META_DATA)).applicationScale;
    }
    ...
    public static ScreenSize getScreenSize(Context context, ScreenOrientation screenOrientation) {
        ...
        final android.util.DisplayMetrics displayMetrics = context.getResources()
                .getDisplayMetrics();

        /*
         * 默认，宽度小，高度大，例�?320x480 360x640 480x800 480x854
         */
   ...
   public static int getHeight(){
	   if(screenSize==null){
		   screenSize =  getScreenSize(MyApplication.getInstance(),ScreenOrientation.ORIENTATION_UNDEFINED);
	   }
